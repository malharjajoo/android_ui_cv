...
public class SessionCountDown extends AppCompatActivity {
    ...
    public class Timer
    {
        ...
        public Timer(long countdown)
        {
            ...
            this.countdownTextview = findViewById(R.id.text_view_countdown);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        this.resetButton = findViewById(R.id.button_reset);
    ...
    */
    ...
    public void openSessionStartActivity()
    {
        Intent intent = new Intent(SessionCountDown.this, StudySession.class );
