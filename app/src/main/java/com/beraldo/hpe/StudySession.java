...
import com.beraldo.hpe.NoiseTracker.NoiseData;
...
public class StudySession extends AppCompatActivity {
    ...
    DatabaseReference myRef = database.getReference("StudyBuddy");
    ...
    public static class Summary implements Parcelable
    {
        ...
        public Summary(StatsSummary statsSummary, String sessionDuration)
        {
            ...
            this.focussed_percent = statsSummary.focussed_percent;
            this.distracted_percent = statsSummary.distracted_percent;
            this.notpresent_percent = statsSummary.notpresent_percent;
            this.avgNoise = statsSummary.avgNoise;
        }
    ...
    public class MySession
    {
        ...
        public void stopSession()
        {
            ...
            if(this.sessionState == SessionState.STARTED)
            {
                ...
                /**
                 * Sending to Firebase here.
                 */
                //final DatabaseReference sessionRef = myRef.child();
                final Map<String, Summary> Sessions = new HashMap<>(); // This is the Parent map
                Sessions.put("Session",summary);
                myRef.push().setValue(Sessions);
